...
//
// Behavior script: massRenderStart
//
public sealed class massRenderStart : LingoBehaviorScript {
...
_movieScript.global_ldprps = new LingoPropertyList {[new LingoSymbol("lstup")] = 1,[new LingoSymbol("lstDwn")] = 1,[new LingoSymbol("lft")] = 1,[new LingoSymbol("rgth")] = 1,[new LingoSymbol("lstenter")] = 0,[new LingoSymbol("currproject")] = 1,[new LingoSymbol("listscrollpos")] = 1,[new LingoSymbol("listshowtotal")] = 30};
_global.member(@"ProjectsL").text = txt;
_global.member(@"PalName").text = @"Press 'A' to select all in folder. Press 'C' to deselect all. Press ENTER to start rendering.";
