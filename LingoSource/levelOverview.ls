...
on goToEditor me
  goFrm = 0
  if _key.keyPressed("1") then
    goFrm = 9
  else  if _key.keyPressed("2") then
    goFrm = 15
  else  if _key.keyPressed("3") then
    goFrm = 25
  else  if _key.keyPressed("4") then
    goFrm = 33
  else  if _key.keyPressed("5") then
    goFrm = 38
  else  if _key.keyPressed("6") then
    goFrm = 18
  end if
