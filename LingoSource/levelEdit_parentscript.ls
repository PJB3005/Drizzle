...
on newUpdate me
  ...
  case p.playerNum of
    1:
      p.Input[1].locH =  p.Input[1].locH - _key.keyPressed(123)
      p.Input[1].locH =  p.Input[1].locH + _key.keyPressed(124)
      --if p.Input[1].locH = 0 then
      p.Input[1].locV =  p.Input[1].locV - _key.keyPressed(126)
      p.Input[1].locV =  p.Input[1].locV + _key.keyPressed(125)
      --end if
      p.Input[2] = _key.keyPressed("K")
      p.Input[3] = _key.keyPressed("L")
    ...
    2:
      ...
      p.Input[1].locH =  p.Input[1].locH - _key.keyPressed("S")
      p.Input[1].locH =  p.Input[1].locH + _key.keyPressed("F")
      p.Input[1].locV =  p.Input[1].locV - _key.keyPressed("E")
      p.Input[1].locV =  p.Input[1].locV + _key.keyPressed("D")
      p.Input[2] = _key.keyPressed("Q")
      p.Input[3] = _key.keyPressed("W")
  end case
